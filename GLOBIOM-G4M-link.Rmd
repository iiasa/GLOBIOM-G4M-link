...
This notebook has a default configuration `R/default_configuration.R`. Adjust the configuration to your requirements. Do not edit the default configuration file, but instead copy it to a separate `.R` configuration file with a name of your choosing and edit the copy. 
...
rm(args, config_names, config_types)
...
## Cache working directory and load support functions
